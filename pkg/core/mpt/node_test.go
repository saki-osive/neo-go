...
func TestNode_Serializable(t *testing.T) {
	...
	t.Run("Extension", func(t *testing.T) {
		t.Run("Good", func(t *testing.T) {
			...
			t.Run("WithType", getTestFuncEncode(true, &NodeObject{e, 0}, new(NodeObject)))
		})
	...
	t.Run("Branch", func(t *testing.T) {
		...
		t.Run("WithType", getTestFuncEncode(true, &NodeObject{b, 0xFFEE}, new(NodeObject)))
	})
	...
	t.Run("Hash", func(t *testing.T) {
		t.Run("Good", func(t *testing.T) {
			...
			t.Run("WithType", getTestFuncEncode(true, &NodeObject{h, 11}, new(NodeObject)))
		})
